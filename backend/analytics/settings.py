"""
Django settings for hn_dashboard project.
...
SECRET_KEY = os.getenv("SECRET_KEY", default="django-insecure-#&dsdq#+7yit-)sa%gd!b$ke4tmj4r1s9qno%a0o4u#4j)5!ui")
...
ROOT_URLCONF = 'hn_dashboard.urls'
...
# For production, specify allowed origins instead of using ALLOW_ALL
